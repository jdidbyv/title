...
def set_args():
    ...
    parser.add_argument('--num_train_epochs', default=3, type=int, help='模型训练的轮数')
    ...
    parser.add_argument('--learning_rate', default=0.1, type=float, help='模型训练时的学习率')
    ...
    parser.add_argument('--max_len', type=int, default=1500, help='输入模型的最大长度，要比config中n_ctx小')
    parser.add_argument('--title_max_len', type=int, default=30, help='生成标题的最大长度，要比max_len小')
